<?php
$pageTitle = 'Sales — ' . e($book['name']);
$summary   = $summary ?? ['total_sales'=>0,'collected'=>0,'due'=>0,'count'=>0];
ob_start();
?>
<div class="page-header">
    <div class="page-header-left">
        ...
        <h1><i class="fa-solid fa-arrow-trend-up" style="color:var(--brand)"></i> Sales</h1>
        <p>Customer invoices, receipts and sales history</p>
    </div>
...
<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(160px,1fr));gap:14px;margin-bottom:20px">
    <div class="card" style="text-align:center">
        <div style="font-size:11px;font-weight:700;text-transform:uppercase;color:var(--text-muted);letter-spacing:.5px"><i class="fa-solid fa-arrow-up-right-dots"></i> Total Sales</div>
        <div style="font-size:22px;font-weight:800;color:var(--green);margin-top:4px"><?= format_money($summary['total_sales'] ?? 0) ?></div>
    </div>
    <div class="card" style="text-align:center">
        <div style="font-size:11px;font-weight:700;text-transform:uppercase;color:var(--text-muted);letter-spacing:.5px"><i class="fa-solid fa-check-double"></i> Collected</div>
        <div style="font-size:22px;font-weight:800;color:var(--brand);margin-top:4px"><?= format_money($summary['collected'] ?? 0) ?></div>
    </div>
    <div class="card" style="text-align:center">
    ...
    <div class="card" style="text-align:center">
        <div style="font-size:11px;font-weight:700;text-transform:uppercase;color:var(--text-muted);letter-spacing:.5px"><i class="fa-solid fa-file-invoice"></i> Invoices</div>
...
<div class="lm-controls">
    <div class="lm-search-wrap">
        ...
        <input type="text" class="lm-search" id="invSearch" placeholder="Search invoice no., customer name…">
    ...
    <select class="lm-select" id="invSort" title="Sort">
        ...
        <option value="party-asc">Customer A–Z</option>
...
<div style="display:flex;align-items:center;gap:8px;margin-bottom:14px;flex-wrap:wrap">
    ...
    <div style="text-align:center;min-width:140px">
        ...
        <div style="font-size:11px;color:var(--text-muted)"><?= count($invoices) ?> sales</div>
    </div>
...
<div class="table-wrap">
    <div class="empty-state">
        <div class="empty-icon"><i class="fa-solid fa-arrow-trend-up"></i></div>
        <h3>No sales yet</h3>
        <p>Create your first sale invoice to get started.</p>
        <a href="/books/<?= $book['id'] ?>/invoices/create?type=sale" class="btn btn-primary">
            <i class="fa-solid fa-plus"></i> New Sale Invoice
        </a>
    </div>
</div>
<?php else: ?>
<div class="table-wrap">
    <table id="invTable">
        ...
        <tr data-status="<?= e($inv['status']) ?>" data-date="<?= e($inv['date'] ?? '') ?>">
            ...
            <td class="td-muted"><?= e($inv['customer_name'] ?? '—') ?></td>
...
(function(){
    ...
    function render() {
        ...
        if (pageRows.length===0) {
            ...
            noD.textContent=searchQ?'No sales match "'+searchQ+'"':'No sales match the selected filters.';
